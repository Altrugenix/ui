    ...
    return (
      <div className="flex w-full flex-col space-y-1.5">
        ...
        <input
          ...
          ref={ref}
          className={cn(
            "bg-secondary focus-visible:ring-ring h-2 w-full cursor-pointer appearance-none rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
