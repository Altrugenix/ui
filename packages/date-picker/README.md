...
<a href="https://www.npmjs.com/package/@altrugenix/date-picker"><img alt="NPM version" src="https://img.shields.io/npm/v/@altrugenix/date-picker.svg?style=for-the-badge&labelColor=000000"></a>
<a href="https://github.com/Altrugenix/ui/blob/main/LICENSE"><img alt="License" src="https://img.shields.io/npm/l/@altrugenix/date-picker.svg?style=for-the-badge&labelColor=000000"></a>
...
An open-source, accessible, and high-performance React Date Picker component.

## Installation

```bash
yarn add @altrugenix/date-picker
```
