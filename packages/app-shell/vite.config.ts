...
export default defineConfig({
  ...
  build: {
    lib: {
      ...
      name: "AltrugenixAppShell",
      formats: ["es", "umd"],
      fileName: (format) =>
        `altrugenix-app-shell.${format === "es" ? "js" : "umd.cjs"}`,
    },
    rollupOptions: {
      external: ["react/jsx-runtime", "react", "react-dom", "@altrugenix/core", "@altrugenix/button", "lucide-react"],
      output: {
        globals: {
          react: "React",
          "react-dom": "ReactDOM",
