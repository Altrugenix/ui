...
<a href="https://www.npmjs.com/package/@altrugenix/metric-card"><img alt="NPM version" src="https://img.shields.io/npm/v/@altrugenix/metric-card.svg?style=for-the-badge&labelColor=000000"></a>
<a href="https://github.com/Altrugenix/ui/blob/main/LICENSE"><img alt="License" src="https://img.shields.io/npm/l/@altrugenix/metric-card.svg?style=for-the-badge&labelColor=000000"></a>
...
An open-source, accessible, and high-performance React Metric Card component.

## Installation

```bash
yarn add @altrugenix/metric-card
```
