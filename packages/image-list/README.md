...
<a href="https://www.npmjs.com/package/@altrugenix/image-list"><img alt="NPM version" src="https://img.shields.io/npm/v/@altrugenix/image-list.svg?style=for-the-badge&labelColor=000000"></a>
<a href="https://github.com/Altrugenix/ui/blob/main/LICENSE"><img alt="License" src="https://img.shields.io/npm/l/@altrugenix/image-list.svg?style=for-the-badge&labelColor=000000"></a>
...
An open-source, accessible, and high-performance React Image List component.

## Installation

```bash
yarn add @altrugenix/image-list
```
