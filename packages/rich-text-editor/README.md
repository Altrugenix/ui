<div align="center">
  ...
  <h1>@altrugenix/rich-text-editor</h1>
...
<a href="https://www.npmjs.com/package/@altrugenix/rich-text-editor"><img alt="NPM version" src="https://img.shields.io/npm/v/@altrugenix/rich-text-editor.svg?style=for-the-badge&labelColor=000000"></a>
<a href="https://github.com/Altrugenix/ui/blob/main/LICENSE"><img alt="License" src="https://img.shields.io/npm/l/@altrugenix/rich-text-editor.svg?style=for-the-badge&labelColor=000000"></a>
...
An open-source, accessible, and high-performance React Rich Text Editor component.

## Installation

```bash
yarn add @altrugenix/rich-text-editor
```
