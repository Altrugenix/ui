...
<a href="https://www.npmjs.com/package/@altrugenix/file-upload"><img alt="NPM version" src="https://img.shields.io/npm/v/@altrugenix/file-upload.svg?style=for-the-badge&labelColor=000000"></a>
<a href="https://github.com/Altrugenix/ui/blob/main/LICENSE"><img alt="License" src="https://img.shields.io/npm/l/@altrugenix/file-upload.svg?style=for-the-badge&labelColor=000000"></a>
...
An open-source, accessible, and high-performance React File Upload component.

## Installation

```bash
yarn add @altrugenix/file-upload
```
